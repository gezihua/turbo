...
public class ScreenShotListenManager {
    ...
    public static boolean checkPermission(Context context) {
        try {
            int permission = PermissionChecker.checkSelfPermission(context, "android.permission.READ_EXTERNAL_STORAGE");
    ...
    private void show_dialog(Context context) {
       Toast.makeText(mContext,"请检查存储权限",Toast.LENGTH_LONG).show();
    }
